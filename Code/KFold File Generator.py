# Author: Joshua White
#
# This file will take a csv file of a data set and outputs training and validation sets to use in K-fold cross validation. 
#
# If you used my previous script to break a data set into a test set and training set it will have already randomly sorted the 
# origional data set, but if you would like this script to do it you can set the shuffle tuning knob to true. 
#
# NOTE:
# If the input csv file is not evenly divided by the number of folds the remainder will be added to the test set,
...
shuffle = False
filename = 'C:\\Users\\Joshua\\Google Drive\\CSCE 623 - Machine Learning\\Project\\Code\\training_data_nyc-jobs.csv' # the csv filename you would like to manipulate
validation_filename_helper = 'C:\\Users\\Joshua\\Google Drive\\CSCE 623 - Machine Learning\\Project\\Code\\validation_set_'
training_filename_helper = 'C:\\Users\\Joshua\\Google Drive\\CSCE 623 - Machine Learning\\Project\\Code\\training_set_'
...
for i in range(num_folds):
    ...
    test_filename = validation_filename_helper + str(i) + '.csv'
